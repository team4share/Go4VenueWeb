...
<!-- CSS Theme -->
<link rel="stylesheet"
	href="resources/assets/css/theme-colors/purple.css" id="style_color">
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<ul class="list-inline right-topbar pull-right">
								...
								<li><a href="shop-ui-login.html">Login</a> | <a
									href="shop-ui-register.html">Register</a></li>
			...
			<div class="navbar navbar-default mega-menu" role="navigation">
				<div class="container">
					...
					<div class="collapse navbar-collapse navbar-responsive-collapse">
						<!-- Shopping Cart -->
						<ul
							class="list-inline shop-badge badge-lists badge-icons pull-right">
							<li><a href="#"><i class="fa fa-heart"></i></a> <span
								class="badge badge-sea rounded-x">3</span>
								<ul class="list-unstyled badge-open mCustomScrollbar"
									...
									<li>
										...
										<button type="button" class="close">Ã—</button>
										<div class="overflow-h">
											<span>Venue 3</span> <small></small>
										</div>
									</li>
									<li class="subtotal">
										<div class="overflow-h margin-bottom-10">
											<span>Total Selectd</span> <span
												class="pull-right subtotal-cost">3</span>
										</div>
										<div class="row">
											<div class="col-xs-6">
											...
											<div class="col-xs-6">
												<a href="shop-ui-add-to-cart.html"
													class="btn-u btn-u-sea-shop btn-block">Compare</a>
											</div>
										</div>
									</li>
								</ul></li>
						...
						<ul class="nav navbar-nav">
							...
							<li class="dropdown"><a href="javascript:void(0);"
								class="dropdown-toggle" data-hover="dropdown"
								data-toggle="dropdown"> Promotion </a>
								<ul class="dropdown-menu">
			...
			<div class="row">
							...
							<div class="panel-heading">
								<h2 class="panel-title">
									<a data-toggle="collapse" data-parent="#accordion"
										href="#collapseOne"> Location <i class="fa fa-angle-down"></i>
									</a>
								</h2>
							</div>
							<div id="collapseOne" class="panel-collapse collapse in">
								<div class="panel-body">
									<ul class="list-unstyled checkbox-list">
										<li ng-repeat="city in cities"><label class="checkbox"> 
											 <input type="checkbox" name="checkbox" ng-model="Cusine1" />{{city.name}}
										</label></li>
									</ul>
								</div>
							</div>
								...
								<div class="panel-body">
									<ul class="list-unstyled checkbox-list">
										<li><label class="checkbox"
											ng-repeat="occasion in occasions"> <input
												type="checkbox" name="checkbox" checked /> <i></i>
												{{occasion.name}}
										</label></li>
									</ul>
								</div>
							...
							<div class="panel-heading">
								<h2 class="panel-title">
									<a data-toggle="collapse" data-parent="#accordion-v3"
										href="#collapseThree"> Venue Type <i
										class="fa fa-angle-down"></i>
									</a>
								</h2>
							</div>
							...
							<div class="panel-heading">
								<h2 class="panel-title">
									<a data-toggle="collapse" data-parent="#accordion-v4"
										href="#collapseFour"> Capacity <i class="fa fa-angle-down"></i>
									</a>
								</h2>
							</div>
								...
								<div class="panel-body">
									<ul class="list-unstyled checkbox-lis">
										<li ng-repeat="amenity in amenities"><input
											type="checkbox" name="checkbox" checked /> <i
				...
				<div class="col-md-9">
					...
					<div class="filter-results">
						...
						<div
							ng-repeat="venueData in venues | pagination : currentPage*itemsPerPage | limitTo: itemsPerPage">
										...
										<div class="overflow-h margin-bottom-5">
											<ul class="list-inline overflow-h">
												<li><h4 class="title-price">
														<a href="shop-ui-inner.html">{{venueData.venueName}}</a>
													</h4></li>
											...
											<div class="margin-bottom-10">
												<span class="title-price margin-right-10">{{venueData.venuePrice}}</span>
											</div>
						...
						<div class="pagination pagination-v2">
							...
							<ul class="pagination">
								...
								<li ng-class="DisableNextPage()"><a href
									ng-click="nextPage()">Next &raquo;</a></li>
							</ul>
			...
			<div class="copyright">
				<div class="container">
					<div class="row">
						<div class="col-md-6">
							<p>
								2015 &copy; Go4Venue. ALL Rights Reserved. <a href="#">Privacy
