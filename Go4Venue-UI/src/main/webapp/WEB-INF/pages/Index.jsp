...
<div class="wrapper">
    ...
    <!-- Image Gradient Go4Venue -->
        ...
        <div class="container" ng-controller = "SearchController">
            ...
            <br>
            <button class="btn-u btn-brd btn-brd-hover btn-u-light" ><a href="#how_it_works">  How It works</a></button>
    	...
    	<div class="row margin-bottom-5">
    		...
    		<div class="col-md-8 md-margin-bottom-5">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <p>There are ample reasons to choose Go4Venue. Let us write few of them!</p>
                        <ul class="list-unstyled margin-bottom-20">
                            <li><i class="fa fa-check color-green"></i> Easy Venue Searching </li>
                            <li><i class="fa fa-check color-green"></i> Hassle Free Bookings</li>
                            <li><i class="fa fa-check color-green"></i> Compare Venues and Choose Best</li>
                            <li><i class="fa fa-check color-green"></i> Get Quoutes From Mutliple Venues</li>
                            <li><i class="fa fa-check color-green"></i> Lowest Cost Gauranteed </li>
                ...
                <blockquote class="hero-unify">
                    <p>" Because we believe that you don't host events, you host Memories!"</p>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3 md-margin-bottom-40">
                        ...
                        <p>Welcome to Go4Venue we provide a wonderful experince to make your event a memorable one </p>
                        <p></p>
                    </div><!--/col-md-3-->
                    <!-- End About -->
