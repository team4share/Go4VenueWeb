...
<div class="wrapper">
                ...
                <div class="row">
                    <div class="col-sm-8">
                        <ul class="list-inline top-v2-contacts">
                            <li>Email: <a href="mailto:support@go4venue.com">support@go4venue.com</a></li>
                ...
                <div class="collapse navbar-collapse navbar-responsive-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown active">
                            <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown">Browse Venues</a>
                        ...
                        <!-- Pages -->
                        <li class="">
                            <a href="javascript:void(0);"  class="btn-u btn-brd btn-brd-hover btn-u-light" >Get Quote</a>  
                        </li>
                        <!-- End Pages -->
                        <!-- Blog -->
                        <li class="dropdown">
    ...
    <div class="container content-sm">
    	...
    	<div class="row margin-bottom-30">
        	...
        	<div class="col-md-4">
        		<div class="service">
        			...
        			<div class="desc">
        				<h4>Select</h4>
                        <p>Select the venues as per your requirement, Grab the best deal </p>
        			</div>
        		</div>
        	</div>
        	<div class="col-md-4">
    	...
    	<!-- Recent Works -->
        <div class="headline"><h2>Book The Event</h2></div>
        <div class="row margin-bottom-20">
            <div class="col-md-3 col-sm-6">
                <div class="thumbnails thumbnail-style thumbnail-kenburn">
                	<div class="thumbnail-img">
                        <div class="overflow-hidden">
                            <img class="img-responsive" src="resources/assets/img/main//wedding.jpg" alt="">
                        </div>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="thumbnails thumbnail-style thumbnail-kenburn">
                    <div class="thumbnail-img">
                        <div class="overflow-hidden">
                            <img class="img-responsive" src="resources/assets/img/main/coktail.jpg" alt="">
                        </div>
                        <a class="btn-more hover-effect" href="#">read more +</a>
                    </div>
                    <div class="caption">
                        <h3><a class="hover-effect" href="#">Cocktail Party</a></h3>
                        <p></p>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="thumbnails thumbnail-style thumbnail-kenburn">
                    <div class="thumbnail-img">
                        <div class="overflow-hidden">
                            <img class="img-responsive" src="resources/assets/img/main/conf.jpg" alt="">
                        </div>
                        <a class="btn-more hover-effect" href="#">read more +</a>
                    </div>
                    <div class="caption">
                        <h3><a class="hover-effect" href="#">Corporate Conference</a></h3>
                        <p></p>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="thumbnails thumbnail-style thumbnail-kenburn">
                    <div class="thumbnail-img">
                        <div class="overflow-hidden">
                            <img class="img-responsive" src="resources/assets/img/main/birthday.jpg" alt="">
                        </div>
                        <a class="btn-more hover-effect" href="#">read more +</a>
                    </div>
                    <div class="caption">
                        <h3><a class="hover-effect" href="#">Birthday Party</a></h3>
                        <p></p>
                    </div>
                </div>
            </div>
    	...
    	<div class="row margin-bottom-30">
    		...
    		<div class="col-md-8 md-margin-bottom-40">
    			<div class="headline"><h2>How It works?</h2></div>
                <div class="row">
                    <div class="col-sm-4">
                        <img class="img-responsive margin-bottom-20" src="resources/assets/img/main/How_we_work.jpg" alt="">
                    </div>
                    <div class="col-sm-8">
                        <p>Hello ! Welcome toh Go4 Venue ,The one Notch Solution For hassle free Venue Bookings.</p>
                        <ul class="list-unstyled margin-bottom-20">
                            <li><i class="fa fa-check color-green"></i> Browse</li>
                            <li><i class="fa fa-check color-green"></i> Compare</li>
                            <li><i class="fa fa-check color-green"></i> Get Qoute</li>
                            <li><i class="fa fa-check color-green"></i> Bid/Book Online</li>
                        </ul>
                    </div>
                </div>

                <blockquote class="hero-unify">
                    <p>Go4Venue promises you the best &amp; the fsatest service at the nominal price.</p>
            ...
            <!-- Featured Venues -->
            <div class="col-md-4">
    			<div class="headline"><h2>Featured Venues</h2></div>
        ...
        <!-- Owl Clients v1 -->
        <div class="headline"><h2>Client Testmonials</h2></div>
        <div class="owl-clients-v1">
            <div class="item">
                <img src="resources/assets/img/Testimonials/img1.jpg" alt="">
                
            </div>
            <div class="item">
                <img src="resources/assets/img/Testimonials/img2.jpg" alt="">
                
            </div>
            <div class="item">
                <img src="resources/assets/img/Testimonials/img3.jpg" alt="">
                
            </div>
            <div class="item">
                <img src="resources/assets/img/Testimonials/img4.jpg" alt="">
                
            </div>
            <div class="item">
                <img src="resources/assets/img/Testimonials/img5.jpg" alt="">
                
            </div>
            <div class="item">
                <img src="resources/assets/img/Testimonials/img7.jpg" alt="">
                
            </div>
            <div class="item">
                <img src="resources/assets/img/Testimonials/img6.jpg" alt="">
